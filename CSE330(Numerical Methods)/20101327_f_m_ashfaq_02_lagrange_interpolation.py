# -*- coding: utf-8 -*-
"""20101327_F_M_Ashfaq_02_Lagrange_Interpolation.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/13pxBWNgUuk2r9qOl_MV3dtzYW-2syKC1
...
class Lagrange_Polynomial:
    ...
    def __call__(self, x_arr):
        ...
        # --------------------------------------------
        # YOUR CODE HERE 
        for i, x in enumerate(x_arr):        #o-n porjonto y_k, l_k multiply korsey, upore formula deya asey
