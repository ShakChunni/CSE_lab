# -*- coding: utf-8 -*-
"""20101327_F_M_Ashfaq_02_Polynomial_Interpolation.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1KiWNG219RoFYOtb9Pc0_hajPxlkyeeo_
...
def get_poly(data_x, data_y):
    ...
    for i in range(n_nodes):
        for j in range(n_nodes):
            X[i, j] = data_x[i] ** j  #vandermod matrix ber kore polynomial ber korsi
    #raise NotImplementedError()
    print(X)
    # --------------------------------------------
